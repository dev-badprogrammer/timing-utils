 ...
 * </pre>
 *
 * <p>A ninth scenario demonstrates failure tracking during repeated measurement, beyond the eight base variants
 * above.</p>
 */
public class StopWatchDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TimedResult<Void> timedResult1 = StopWatch.measure(StopWatchDemo::publishEvent);
        System.out.println("TimedResult:" + timedResult1);
        System.out.println("Result:" + timedResult1.getResult() + " (always null for void methods)");

        separator("SCENARIO 2: measure(Supplier) — returns value, no checked exception");
        TimedResult<String> timedResult2 = StopWatch.measure(() -> StopWatchDemo.getUserById(123));
        System.out.println("TimedResult:" + timedResult2);
        System.out.println("Result:" + timedResult2.getResult());

        separator("SCENARIO 3: measureChecked(CheckedRunnable) — returns void, checked exception");
        TimedResult<Void> timedResult3 = StopWatch.measureChecked(StopWatchDemo::closeConnection);
        System.out.println("TimedResult:" + timedResult3);
        System.out.println("Result:" + timedResult3.getResult() + " (always null for void methods)");

        separator("SCENARIO 4: measureChecked(CheckedSupplier) — returns value, checked exception");
        TimedResult<String> timedResult4 = StopWatch.measureChecked(StopWatchDemo::getConnection);
        System.out.println("TimedResult:" + timedResult4);
        System.out.println("Result:" + timedResult4.getResult());
        ...
        System.out.println("Stats:" + stats5);
