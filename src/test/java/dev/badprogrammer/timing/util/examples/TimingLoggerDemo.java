...
public class TimingLoggerDemo {
    ...
    /**
     * Returns a value and declares a checked exception, with a slow threshold — logs at WARN if elapsed time
     * exceeds 5ms.
     */
    @SuppressWarnings("java:S1130")
    ...
    /**
     * Returns a value and declares a checked exception — the exception propagates naturally, uncaught.
     */
